...
public class CentralBank implements BaseBank {
    // Implement the CentralBank class based on the description in Task 1.
    ...
    public String getStatistics() {
        ...
        sb.append("Name: ").append(name).append(", Type: ").append("CentralBank").append("\n");
        sb.append("Clients: ");
        if (clients.isEmpty()) {
            sb.append("none");
        } else {
